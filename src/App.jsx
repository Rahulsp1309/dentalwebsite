...
export default function SmyluxeDentalStudio() {
    ...
    if (showWelcomePopup) {
        return (
            // The overlay must cover the entire screen to block interaction
            <div 
                className="fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm transition-opacity duration-500 ease-in-out"
                // No click handler on the outside div, forces user to click the button
            >
                <div 
                    className="bg-white p-12 sm:p-16 rounded-3xl shadow-2xl max-w-lg w-11/12 text-center transform transition-all duration-500 ease-in-out scale-100"
                ...
                >
                    ...
                    <button
                        // This button sets the state to false, causing the entire site to render
                        onClick={() => setShowWelcomePopup(false)}
                        className="mt-8 px-8 py-3 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
                        style={BUTTON_STYLE}
                    >
                        Start Exploring
                    </button>
                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-16 relative z-10">
                    <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
                        ...
                        <p className="text-lg md:text-xl max-w-xl mx-auto lg:mx-0 leading-relaxed" style={{ color: TEXT_GRAY_SECONDARY }}>
                            Experience the pinnacle of **modern dental artistry** in a serene, spa-like studio. We blend advanced technology
